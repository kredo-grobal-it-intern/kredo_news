<div class="container">
    ...
    <div class="row mt-4 px-3">
        <div class="col-lg-3 col-md-6 col-12 mx-auto mb-4 mb-lg-0 footer-content">
            ...
            <ul class="footer-list">
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item">Top</a>
                </li>
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item">About</a>
                </li>
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item">Terms & Conditions</a>
                </li>
                <li class="text-gray px-2 mb-2">
        ...
        <div class="col-lg-3 col-md-6 col-12 mx-auto mb-4 mb-lg-0 footer-content">
            ...
            <ul class="footer-list">
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item">Our Company</a>
                </li>
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item">Careers</a>
                </li>
            </ul>
        </div>
        <div class="col-lg-3 col-md-6 col-12 mx-auto mb-4 mb-lg-0 footer-content">
        ...
        <div class="col-lg-3 col-md-6 col-12 mx-auto mb-4 mb-lg-0 footer-content">
            ...
            <ul class="footer-list">
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item"><i class="fa-solid fa-house me-2"></i>New York, NY 10012, US</a>
                </li>
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item"><i class="fa-solid fa-envelope me-2"></i>info@example.com</a>
                </li>
                <li class="text-gray px-2 mb-2">
                    <a href="" class="text-reset footer-list-item"><i class="fa-solid fa-phone me-2"></i>+ 01 234 567 88</a>
                </li>
            </ul>
        </div>
    </div>

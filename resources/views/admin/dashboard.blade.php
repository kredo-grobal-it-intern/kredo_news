...
@section('content')
        ...
        <div class="row justify-content-center mt-4 text-danger">
          ...
          <div class="col-3">
            <div class="card text-center pb-0 bg-light">
              <div class="card-body  py-3 display-5 fw-bold">{{ number_format($comments_hidden->whereNotNull('u_deleted_at')->count()+ $comments_hidden->whereNotNull('c_deleted_at')->whereNull('u_deleted_at')->count() ) }}</div>
              <div class="card-footer bg-light">

<section class="country-section">
    <div class="text-center my-4">
        <h2 class="country fw-bold">Europe</h2>
    </div>
        ...
        <div class="col-9">
            ...
            <div class="row top-article">
                ...
                <div class="col-5">
                    ...
                    <h3 class="fw-bold top-heading"><a href="" class="text-danger text-decoration-none">{{ $articles['europe']['latest']->title }}</a></h3>
                    <p class="mt-3 top-description">{{ $articles['europe']['latest']->description }}</p>
                    <p class="mt-3">
                ...
                <div class="col-7">
                    <!-- article image -->
                    <a href=""><img src="{{ asset('images/news/' . $articles['europe']['latest']->image) }}" alt="{{ $articles['europe']['latest']->image }}" class="w-100 top-image"></a>
                </div>
            </div>

            <div class="row mt-5 sub-article">
                @foreach ($articles['europe']['sub'] as $article)

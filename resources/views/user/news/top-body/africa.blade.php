<section class="country-section">
    <div class="text-center my-4">
        <h2 class="country fw-bold">Africa</h2>
    </div>
        ...
        <div class="col-9">
            ...
            <div class="row top-article">
                ...
                <div class="col-5">
                    ...
                    <h3 class="fw-bold top-heading"><a href="" class="text-danger text-decoration-none">{{ $articles['africa']['latest']->title }}</a></h3>
                    <p class="mt-3 top-description">{{ $articles['africa']['latest']->description }}</p>
                    <p class="mt-3">
                ...
                <div class="col-7">
                    <!-- article image -->
                    <a href=""><img src="{{ asset('images/news/' . $articles['africa']['latest']->image) }}" alt="{{ $articles['africa']['latest']->image }}" class="w-100 top-image"></a>
                </div>
            </div>

            <div class="row mt-5 sub-article">
                @foreach ($articles['africa']['sub'] as $article)

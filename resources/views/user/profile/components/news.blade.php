<div class="col-lg-3 col-md-6 mb-4">
    <div class="card">
        ...
        <div class="row align-items-center">
            <p class="col offset-1 fs-5">{{$reaction->getLike()->count()}} <i class="fa-regular fa-thumbs-up"></i></p>
            <p class="col fs-5">{{$reaction->getDislike()->count()}} <i class="fa-regular fa-thumbs-down"></i></p>

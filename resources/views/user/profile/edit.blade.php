...
<div class="container">
    ...
    @method('patch')
        ...
        <div class="row mt-5 align-items-start w-75 mx-auto">
            <div class="col-md-4">
                @if ($user->avatar)
                <img src="{{asset('/images/avatars/'.$user->avatar)}}" alt="Image" class="rounded-circle d-block mx-auto profile_image" >
                @else
                <i class="fa-solid fa-circle-user text-secondary d-block text-center profile_icon"></i>
                @endif

                <div class="text-center mt-2 ">
                    <label class="px-2 text-center upload_icon">
                        <input type="file" name="avatar" class="upload_input">
        ...
        <section  class="mx-auto">
            ...
            <div class="row mx-0 favorite_border" >
            ...
            <button type="submit"class="form-control fw-bold fs-5 btn btn-sm w-50 mt-5 mx-auto d-block profile_button">SAVE</button>
        </section>
    </form>
</div>
@endsection
...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        $countries = [
            ...
            ['id' => 3, 'name' => 'Albania'],
            ['id' => 4, 'name' => 'Algeria','continent' => 'Africa'],
            ...
            ['id' => 17, 'name' => 'Bahamas'],
            ['id' => 18, 'name' => 'Bahrain','continent' => 'Asia'],
            ['id' => 19, 'name' => 'Bangladesh'],
            ['id' => 20, 'name' => 'Barbados'],
            ['id' => 21, 'name' => 'Belarus'],
            ['id' => 22, 'name' => 'Belgium','continent' => 'Europe'],
            ['id' => 23, 'name' => 'Belize'],
            ['id' => 24, 'name' => 'Benin'],
            ['id' => 25, 'name' => 'Bermuda'],
            ['id' => 26, 'name' => 'Bhutan','continent' => 'Asia'],
            ...
            ['id' => 49, 'name' => 'Colombia'],
            ['id' => 50, 'name' => 'Comoros'],
            ['id' => 51, 'name' => 'Congo','continent' => 'Africa'],
            ...
            ['id' => 58, 'name' => 'Curaçao'],
            ['id' => 59, 'name' => 'Cyprus'],
            ['id' => 60, 'name' => 'Czech Republic','continent' => 'Europe'],
            ['id' => 61, 'name' => 'Denmark'],
            ['id' => 62, 'name' => 'Djibouti'],
            ['id' => 63, 'name' => 'Dominica'],
            ...
            ['id' => 69, 'name' => 'Eritrea'],
            ['id' => 70, 'name' => 'Estonia'],
            ['id' => 71, 'name' => 'Ethiopia','continent' => 'Africa'],
            ['id' => 72, 'name' => 'Falkland Islands (Malvinas)'],
            ['id' => 73, 'name' => 'Faroe Islands'],
            ['id' => 74, 'name' => 'Fiji'],
            ['id' => 75, 'name' => 'Finland','continent' => 'Europe'],
            ...
            ['id' => 81, 'name' => 'Gambia'],
            ['id' => 82, 'name' => 'Georgia'],
            ['id' => 83, 'name' => 'Germany','continent' => 'Europe'],
            ['id' => 84, 'name' => 'Ghana'],
            ...
            ['id' => 105, 'name' => 'Iran, Islamic Republic of','continent' => 'Asia'],
            ['id' => 106, 'name' => 'Iraq'],
            ['id' => 107, 'name' => 'Ireland'],
            ['id' => 108, 'name' => 'Isle of Man'],
            ['id' => 109, 'name' => 'Israel','image'=>'israel.jpg','continent' => 'Asia'],
            ['id' => 110, 'name' => 'Italy','continent' => 'Europe'],
            ['id' => 111, 'name' => 'Jamaica'],
            ...
            ['id' => 118, 'name' => 'Korea, Democratic People\'s Republic of','continent' => 'Asia'],
            ['id' => 119, 'name' => 'Korea, Republic of','image'=>'korea.jpg'],
            ['id' => 120, 'name' => 'Kuwait'],
            ...
            ['id' => 131, 'name' => 'Macao'],
            ['id' => 132, 'name' => 'Macedonia, the Former Yugoslav Republic of','continent' => 'Europe'],
            ...
            ['id' => 151, 'name' => 'Morocco'],
            ['id' => 152, 'name' => 'Mozambique','continent' => 'Africa'],
            ['id' => 153, 'name' => 'Myanmar'],
            ['id' => 154, 'name' => 'Namibia'],
            ['id' => 155, 'name' => 'Nauru'],
            ['id' => 156, 'name' => 'Nepal'],
            ...
            ['id' => 159, 'name' => 'New Zealand','continent' => 'Oceania'],
            ...
            ['id' => 167, 'name' => 'Oman'],
            ['id' => 168, 'name' => 'Pakistan','continent' => 'Asia'],
            ['id' => 169, 'name' => 'Palau'],
            ...
            ['id' => 177, 'name' => 'Poland','continent' => 'Europe'],
            ['id' => 178, 'name' => 'Portugal','continent' => 'Europe'],
            ['id' => 179, 'name' => 'Puerto Rico'],
            ['id' => 180, 'name' => 'Qatar'],
            ['id' => 181, 'name' => 'Réunion'],
            ['id' => 182, 'name' => 'Romania'],
            ['id' => 183, 'name' => 'Russian Federation','image'=>'russia.jpg','continent' => 'Europe'],
            ['id' => 184, 'name' => 'Rwanda'],
            ...
            ['id' => 205, 'name' => 'Somalia','continent' => 'Africa'],
            ...
            ['id' => 227, 'name' => 'Tunisia'],
            ['id' => 228, 'name' => 'Turkey','continent' => 'Asia'],
